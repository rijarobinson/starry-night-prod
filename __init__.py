...
CLIENT_ID = (json.loads(open('/var/www/FlaskApp/StarryNightProd/client_secrets.json', 'r')
                        .read())['web']['client_id'])
...
def gconnect():
    ...
    try:
        ...
        oauth_flow = flow_from_clientsecrets('/var/www/FlaskApp/StarryNightProd/client_secrets.json', scope='')
...
def fbconnect():
    ...
    app_id = json.loads(open('/var/www/FlaskApp/StarryNightProd/fb_client_secrets.json', 'r').read())[
        'web']['app_id']
    app_secret = json.loads(
        open('/var/www/FlaskApp/StarryNightProd/fb_client_secrets.json', 'r').read())['web']['app_secret']
